...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity() {
        return new UserProfile().fullName(DEFAULT_FULL_NAME).phoneNumber(DEFAULT_PHONE_NUMBER).bio(DEFAULT_BIO);
    }
    ...
    public static UserProfile createUpdatedEntity() {
        return new UserProfile().fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER).bio(UPDATED_BIO);
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER).bio(UPDATED_BIO);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.fullName(UPDATED_FULL_NAME).bio(UPDATED_BIO);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.fullName(UPDATED_FULL_NAME).phoneNumber(UPDATED_PHONE_NUMBER).bio(UPDATED_BIO);
