...
import static org.jhipster.taskflow.domain.NotificationAsserts.*;
...
import org.jhipster.taskflow.repository.NotificationRepository;
import org.jhipster.taskflow.repository.UserRepository;
import org.jhipster.taskflow.service.NotificationService;
import org.jhipster.taskflow.service.dto.NotificationDTO;
import org.jhipster.taskflow.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
    ...
    public static Notification createEntity() {
        return new Notification().message(DEFAULT_MESSAGE).timestamp(DEFAULT_TIMESTAMP).isRead(DEFAULT_IS_READ);
    }
    ...
    public static Notification createUpdatedEntity() {
        return new Notification().message(UPDATED_MESSAGE).timestamp(UPDATED_TIMESTAMP).isRead(UPDATED_IS_READ);
    }
    ...
    void putExistingNotification() throws Exception {
        ...
        updatedNotification.message(UPDATED_MESSAGE).timestamp(UPDATED_TIMESTAMP).isRead(UPDATED_IS_READ);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.message(UPDATED_MESSAGE).timestamp(UPDATED_TIMESTAMP).isRead(UPDATED_IS_READ);
