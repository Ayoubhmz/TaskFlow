...
describe('Task Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Project query and add missing value', () => {
      ...
      const project: IProject = { id: 7741 };
      task.project = project;

      const projectCollection: IProject[] = [{ id: 20733 }];
    ...
    it('Should call User query and add missing value', () => {
      const task: ITask = { id: 456 };
      const assignedTo: IUser = { id: 14838 };
      task.assignedTo = assignedTo;

      const userCollection: IUser[] = [{ id: 21569 }];
    ...
    it('Should update editForm', () => {
      const task: ITask = { id: 456 };
      const project: IProject = { id: 27363 };
      task.project = project;
      const assignedTo: IUser = { id: 31413 };
      task.assignedTo = assignedTo;
